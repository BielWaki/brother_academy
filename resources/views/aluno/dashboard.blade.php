            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1 bg-white p-6 rounded-xl shadow-lg border border-slate-200">
                    ...
                    <div class="space-y-3 text-gray-700">
                        ...
                        <button class="w-full mt-4 py-2 px-4 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition duration-150">
                            Ver Perfil Completo
                        </button>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1 bg-white p-6 rounded-xl shadow-lg border border-slate-200">
                    ...
                    <div class="space-y-3 text-gray-700">
                        ...
                        <button class="w-full mt-4 py-2 px-4 border border-transparent rounded-lg shadow-md text-white bg-green-500 hover:bg-green-600 transition duration-150">
